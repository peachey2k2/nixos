...
vim.keymap.set('v', '<leader>cs', '"xc[<C-r>x]<Esc>', { desc = '[C]over with [S]quare brackets', noremap = true, silent = true })
vim.keymap.set('v', '<leader>cb', '"xc(<C-r>x)<Esc>', { desc = '[C]over with regular [B]rackets', noremap = true, silent = true })
vim.keymap.set('v', '<leader>ca', '"xc<<C-r>x><Esc>', { desc = '[C]over with [A]ngle brackets', noremap = true, silent = true })
          ...
          preview = {
            mime_hook = function(filepath, bufnr, opts)
              ...
              if is_image(filepath) then
                ...
                vim.fn.jobstart({
                  'catimg', -- TODO: use a proper image viewer
                  filepath,
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>lc', function()
        projectlaunch.toggle_main_menu()
        vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('R', true, false, true), '', false)
      end, { desc = 'Run first command', noremap = true, silent = true })
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        -- tsserver = {},
        hls = {
          -- Enable the language server to launch on Cabal files as well
        ...
        jsonls = {},
        nim_langserver = {},
        -- ['nil'] = {}, -- WHY WOULD YOU NAME IT AFTER A COMMON KEYWORD WTF???
        glslls = {
